...
type ITaskV1 interface {
	...
	AssignTask(ctx context.Context, req *v1.AssignTaskReq) (res *v1.AssignTaskRes, err error)
	GetTaskAssignments(ctx context.Context, req *v1.GetTaskAssignmentsReq) (res *v1.GetTaskAssignmentsRes, err error)
	ReassignTask(ctx context.Context, req *v1.ReassignTaskReq) (res *v1.ReassignTaskRes, err error)
	GetDeviceTaskAssignments(ctx context.Context, req *v1.GetDeviceTaskAssignmentsReq) (res *v1.GetDeviceTaskAssignmentsRes, err error)
	...
	GetTaskLogs(ctx context.Context, req *v1.GetTaskLogsReq) (res *v1.GetTaskLogsRes, err error)
